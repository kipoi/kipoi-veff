...
import kipoi_veff
MODULE_NAME = "kipoi_veff"
ROOT = 'http://kipoi.org/docs/veff/'


# functions to generally exclude
EXCLUDE = {
    'get',
}
...
PAGES = [
    {
        'page': 'api/predict_snvs.md',
        'functions': [kipoi_veff.predict_snvs],
    },
    {
        'page': 'api/score_variants.md',
        'functions': [kipoi_veff.score_variants],
    },
    {
        'page': 'api/scores.md',
        'classes': [v for v in kipoi_veff.scores.scoring_options.values()]
    },
    {
        'page': 'api/MutationMap.md',
        'classes': [kipoi_veff.MutationMap],
    },
    {
        'page': 'api/MutationMapPlotter.md',
        'classes': [kipoi_veff.MutationMapPlotter],
    },
    {
        'page': 'api/KipoiVCFParser.md',
        'classes': [kipoi_veff.parsers.KipoiVCFParser]
    },
...
def class_to_docs_link(cls):
    ...
    assert module_name[: len(MODULE_NAME) + 1] == MODULE_NAME + "."
...
def class_to_source_link(cls):
    ...
    link = 'https://github.com/kipoi/kipoi-veff/blob/master/' + path + '#L' + str(line)
    return '[[source]](' + link + ')'

...
class MutationMapPlotter(object):
    ...
    # Methods
        - **save_to_file(fname)** - save mutation map to a file
              - Arguments
                     - **fname**: file path
        - **plot_mutmap(...)** - Generate a mutation map plot
              - Arguments
                     ...
                     - **limit_region**: Limit the plotted region: Tuple of (x_start, x_end) where both x_*
                         are integer in [0,sequence_length)
                     ...
                     - **minimum_letter_height**: Require a minimum height of the reference base. proportion
                        of maximum letter height. e.g. 0.2
    """
...
class MutationMap(object):
    ...
    # Methods
        - **query_region()** - Generate mutation map from pybedtools.Interval
        - **query_bed()** - Generate mutation map from a bed-file
        - **query_vcf()** - Generate mutation map from a vcf-file
